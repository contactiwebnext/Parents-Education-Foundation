...
app.get("/api/health", (req, res) => {
  res.json({
    ...
    address: "PO Box 1612, Waltham, MA 02454",
...
app.post("/api/chat", async (req, res) => {
  ...
  const systemInstruction = `You are the Parent Education Assistant for Parents Education Foundation (PEF), a nonprofit organization based in Waltham, Massachusetts (Mailing Address: Parents Education Foundation, PO Box 1612, Waltham, MA 02454; Phone: 781-890-6001, Email: BCamenker@yahoo.com).
...
- Organization Contact Info: Parents Education Foundation, PO Box 1612, Waltham, MA 02454; Phone: 781-890-6001; Email: BCamenker@yahoo.com.
